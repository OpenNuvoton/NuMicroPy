...
//Calling flow: NAU88L25_Reset() ---> NAU88L25_Init() --> NAU88L25_DSPConfig()

#define NAUL8825_MIXER_QUERY	(0x1 << 0)
#define NAUL8825_MIXER_MUTE		(0x1 << 1)
#define NAUL8825_MIXER_VOLUME	(0x1 << 2)


typedef struct
{
	mp_hal_pin_obj_t pin_phonejack_en;
	mp_hal_pin_obj_t pin_phonejack_det;
} S_NAU88L25_CONFIG;


void NAU88L25_Reset(I2C_T *i2c);
