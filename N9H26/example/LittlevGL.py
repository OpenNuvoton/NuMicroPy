...
#Enable OSD layer. must enable frame layer first
osd = VP.display(OSDLayer=True, OSDColorKey=0)
osd.init()
...
#Display buffer size 20 line 
buf1_1 = bytearray(320*20*2)
lv.disp_buf_init(disp_buf1,buf1_1, None, len(buf1_1)//2)
disp_drv = lv.disp_drv_t()
lv.disp_drv_init(disp_drv)
disp_drv.buffer = disp_buf1

#Set LVGL flush on frame layer
disp_drv.flush_cb = disp.flush
disp_drv.user_data = {'DISP':disp}

#Set LVGL flush on OSD layer
#disp_drv.flush_cb = osd.flush
#disp_drv.user_data = {'DISP': osd}
