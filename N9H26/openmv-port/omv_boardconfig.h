...
#define OMV_ENABLE_NT99141      (1)

//Sensor I2C pin
#if defined (MICROPY_HW_SENSOR_SCL)
#define SENSOR_I2C_SCL_PIN         MICROPY_HW_SENSOR_SCL
#define SENSOR_I2C_SDA_PIN         MICROPY_HW_SENSOR_SDA
#define SENSOR_POWERDOWN_PIN       MICROPY_HW_SENSOR_POWERDOWN
#define SENSOR_RESET_PIN           MICROPY_HW_SENSOR_RESET
#else
#define SENSOR_I2C_SCL_PIN         (pin_B13)
#define SENSOR_I2C_SDA_PIN         (pin_B14)
#define SENSOR_POWERDOWN_PIN       (pin_E8)
#define SENSOR_RESET_PIN           (pin_B4)
#endif

#define SENSOR_PCLK_48MHZ        48000
#define SENSOR_PCLK_60MHZ        60000
#define SENSOR_PCLK_74MHZ        74000
#define SENSOR_PCLK              SENSOR_PCLK_60MHZ
...
#define VIN_CONFIG_PORT0_PLANAR_FRAME_CNT           (3)             //video-in planar pipe maximum frame buffers. Must >= 3
#define VIN_CONFIG_PORT0_PACKET_FRAME_CNT           (3)             //video-in planar pipe maximum frame buffers. Must >= 3

// FB Heap Block Size
#define OMV_UMM_BLOCK_SIZE      256

#define OMV_FB_ALLOC_SIZE   (84 * 1024)   // minimum fb alloc size
