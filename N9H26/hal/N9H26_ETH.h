...
#ifndef  __N9H26_ETH_H__
#define  __N9H26_ETH_H__
...
#define TX_DESCRIPTOR_NUM 16    // Max number of Tx Frame Descriptors
...
extern int32_t ETH_Init0(void);
extern void ETH_init(uint8_t *mac_addr);
extern uint8_t *ETH_get_tx_buf(void);
extern void ETH_trigger_tx(uint16_t length, struct pbuf *p);
